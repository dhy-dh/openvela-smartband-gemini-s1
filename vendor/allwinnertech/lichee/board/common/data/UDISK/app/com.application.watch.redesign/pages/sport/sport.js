                    ...
                    var $app_script$ = function __scriptModule__(module, exports, $app_require$1) {
                        ...
                        var _default = exports.default = {
                            private: {
                                ...
                                titleClass: "sport-title text-light",
                                catFrames: [],
                                catDuration: "3400ms",
                                activeActionId: "",
                            ...
                            syncCustomization () {
                                ...
                                this.titleClass = "sport-title text-" + background.foreground;
                            ...
                            startCatAnimation () {
                                ...
                                const animator = this.$element("sportCatAnimator");
                                if (!animator) return;
                                try {
                                    animator.start();
                                } catch (error) {
                                    console.log("sport cat animator start failed", error);
                                }
                            },
                            ...
                            pauseCatAnimation () {
                                ...
                                try {
                                    ...
                                    console.log("sport cat animator pause failed", error);
                                }
                            },
                            stopCatAnimation () {
                                if (!this.catAnimatorReady) return;
                                ...
                                try {
                                    ...
                                    console.log("sport cat animator stop failed", error);
                                }
                            },
                            startCatHealthCheck () {
                                ...
                                this.catHealthTimerId = setInterval(()=>{
                                    ...
                                    try {
                                        ...
                                        console.log("sport cat animator health check failed", error);
                                    }
                                }, 10000);
                            },
                            stopCatHealthCheck () {
                            ...
                            onTouchEnd (event) {
                                ...
                                if (deltaX > 60 && Math.abs(deltaX) > 1.2 * Math.abs(deltaY)) this.returnToWeather();
                                if (deltaX < -60 && Math.abs(deltaX) > 1.2 * Math.abs(deltaY)) this.openHealth();
                                if (Math.abs(deltaY) > 60 && Math.abs(deltaY) > 1.2 * Math.abs(deltaX)) this.openSportMode();
                            },
                            handleSwipe (event) {
                                ...
                                if ("right" === direction) this.returnToWeather();
                                if ("left" === direction) this.openHealth();
                                if ("up" === direction || "down" === direction) this.openSportMode();
                            },
                            queueReturn () {
                                this.cancelReturn();
                                this.cancelCatAnimationStart();
                                ...
                                this.returnTimerId = setTimeout(()=>{
                                    ...
                                    try {
                                        ...
                                        this.leaving = false;
                                        console.log("close sport failed", error);
                                    }
                                }, 120);
                            },
                            cancelReturn () {
                            ...
                            openHealth () {
                                ...
                                setTimeout(()=>{
                                    try {
                                        ...
                                        this.queueCatAnimationStart();
                                        this.startCatHealthCheck();
                                        console.log("open health failed", error);
                                    }
                                }, 120);
                            }
                        };
                                ...
                                aiot.__ce__("div", {
                                    ...
                                    aiot.__ce__("image", {
                                        ...
                                        __opts__: {
                                            ...
                                            src: "/common/sport/running-icon.png"
                                        }
                                    }, []),
