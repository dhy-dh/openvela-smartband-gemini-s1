                    ...
                    var $app_script$ = function __scriptModule__(module, exports, $app_require$1) {
                        ...
                        var _default = exports.default = {
                            private: {
                                ...
                                titleClass: "notification-title text-light",
                                catFrames: [],
                                catDuration: "3400ms",
                                activeActionId: "",
                            ...
                            syncCustomization () {
                                ...
                                this.titleClass = "notification-title text-" + background.foreground;
                            ...
                            startCatAnimation () {
                                ...
                                const animator = this.$element("notificationCatAnimator");
                                if (!animator) return;
                                try {
                                    animator.start();
                                } catch (error) {
                                    console.log("notification cat animator start failed", error);
                                }
                            },
                            ...
                            pauseCatAnimation () {
                                ...
                                try {
                                    ...
                                    console.log("notification cat animator pause failed", error);
                                }
                            },
                            stopCatAnimation () {
                                if (!this.catAnimatorReady) return;
                                ...
                                try {
                                    ...
                                    console.log("notification cat animator stop failed", error);
                                }
                            },
                            startCatHealthCheck () {
                                ...
                                this.catHealthTimerId = setInterval(()=>{
                                    ...
                                    try {
                                        ...
                                        console.log("notification cat animator health check failed", error);
                                    }
                                }, 10000);
                            },
                            stopCatHealthCheck () {
                            ...
                            onTouchEnd (event) {
                                ...
                                if (deltaX > 60 && Math.abs(deltaX) > 1.2 * Math.abs(deltaY)) this.openMusic();
                                if (deltaX < -60 && Math.abs(deltaX) > 1.2 * Math.abs(deltaY)) this.openAssistant();
                                if (Math.abs(deltaY) > 60 && Math.abs(deltaY) > 1.2 * Math.abs(deltaX)) this.openHistory();
                            },
                            handleSwipe (event) {
                                ...
                                if ("right" === direction) this.openMusic();
                                if ("left" === direction) this.openAssistant();
                                if ("up" === direction || "down" === direction) this.openHistory();
                            },
                            replacePage (uri) {
                                ...
                                setTimeout(()=>{
                                    try {
                                        ...
                                        this.queueCatAnimationStart();
                                        this.startCatHealthCheck();
                                        console.log("replace notification module failed", error);
                                    }
                                }, 120);
                            },
                            armRouteGuard () {
                                ...
                                this.routeGuardTimerId = setTimeout(()=>{
                                    ...
                                    this.leaving = false;
                                    console.log("notification route guard released");
                                }, 1200);
                            },
                            clearRouteGuard () {
                            ...
                            openMusic () {
                                ...
                                setTimeout(()=>{
                                    try {
                                        ...
                                        this.queueCatAnimationStart();
                                        this.startCatHealthCheck();
                                        console.log("open music module failed", error);
                                    }
                                }, 120);
                            },
                            openAssistant () {
                                this.replacePage("/pages/assistant");
                            },
                            openHistory () {
                                if (this.leaving || this.screenStandby) return;
                                this.leaving = true;
                                ...
                                setTimeout(()=>{
                                    try {
                                        ...
                                        this.queueCatAnimationStart();
                                        this.startCatHealthCheck();
                                        console.log("open notification history failed", error);
                                    }
                                }, 120);
                            }
                        };
                                    ...
                                    aiot.__ce__("div", {
                                        ...
                                        aiot.__ce__("image", {
                                            ...
                                            __opts__: {
                                                ...
                                                src: "/common/notifications/bell.png"
                                            }
                                        }, [])
                                    ]),
