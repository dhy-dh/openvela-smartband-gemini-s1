                    ...
                    var $app_script$ = function __scriptModule__(module, exports, $app_require$1) {
                        ...
                        var _default = exports.default = {
                            private: {
                                ...
                                titleClass: "health-title text-light",
                                catFrames: [],
                                catDuration: "3400ms",
                                activeActionId: "",
                            ...
                            syncCustomization () {
                                ...
                                this.titleClass = "health-title text-" + background.foreground;
                            ...
                            startCatAnimation () {
                                ...
                                const animator = this.$element("healthCatAnimator");
                                if (!animator) return;
                                try {
                                    animator.start();
                                } catch (error) {
                                    console.log("health cat animator start failed", error);
                                }
                            },
                            ...
                            pauseCatAnimation () {
                                ...
                                try {
                                    ...
                                    console.log("health cat animator pause failed", error);
                                }
                            },
                            stopCatAnimation () {
                                if (!this.catAnimatorReady) return;
                                ...
                                try {
                                    ...
                                    console.log("health cat animator stop failed", error);
                                }
                            },
                            startCatHealthCheck () {
                                ...
                                this.catHealthTimerId = setInterval(()=>{
                                    ...
                                    try {
                                        ...
                                        console.log("health cat animator health check failed", error);
                                    }
                                }, 10000);
                            },
                            stopCatHealthCheck () {
                            ...
                            onTouchEnd (event) {
                                ...
                                if (deltaX > 60 && Math.abs(deltaX) > 1.2 * Math.abs(deltaY)) {
                                    console.log("health touch navigation: sport");
                                    this.returnToSport();
                                }
                                if (deltaX < -60 && Math.abs(deltaX) > 1.2 * Math.abs(deltaY)) {
                                    console.log("health touch navigation: music");
                                    this.openMusic();
                                }
                                if (Math.abs(deltaY) > 60 && Math.abs(deltaY) > 1.2 * Math.abs(deltaX)) {
                                    console.log("health touch navigation: heart rate");
                                    this.openHeartRate();
                                }
                            },
                            handleSwipe (event) {
                                ...
                                if ("right" === direction) {
                                    console.log("health swipe navigation: sport");
                                    this.returnToSport();
                                }
                                if ("left" === direction) {
                                    console.log("health swipe navigation: music");
                                    this.openMusic();
                                }
                                if ("up" === direction || "down" === direction) {
                                    console.log("health swipe navigation: heart rate");
                                    this.openHeartRate();
                                }
                            },
                            queueReturn () {
                                ...
                                this.returnTimerId = setTimeout(()=>{
                                    ...
                                    try {
                                        ...
                                        this.leaving = false;
                                        console.log("close health failed", error);
                                    }
                                }, 120);
                            },
                            cancelReturn () {
                            ...
                            armRouteGuard () {
                                ...
                                this.routeGuardTimerId = setTimeout(()=>{
                                    ...
                                    this.leaving = false;
                                    console.log("health route guard released");
                                }, 1200);
                            },
                            clearRouteGuard () {
                            ...
                            openHeartRate () {
                                ...
                                setTimeout(()=>{
                                    try {
                                        ...
                                        this.queueCatAnimationStart();
                                        this.startCatHealthCheck();
                                        console.log("open heart rate failed", error);
                                    }
                                }, 120);
                            },
                            openMusic () {
