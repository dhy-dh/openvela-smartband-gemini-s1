                    ...
                    var $app_script$ = function __scriptModule__(module, exports, $app_require$1) {
                        ...
                        var _default = exports.default = {
                            ...
                            loadActions () {
                                ...
                                this.actions = (0, _customization.getActions)();
                                this.backgroundImage = (0, _customization.getBackground)(customization.backgroundId).src;
                                let selectedIndex = 0;
                                for(let index = 0; index < this.actions.length; index += 1)if (this.actions[index].id === customization.actionId) selectedIndex = index;
                            ...
                            queueReturn () {
                                ...
                                this.returnTimerId = setTimeout(()=>{
                                    ...
                                    try {
                                        ...
                                        this.leaving = false;
                                        console.log("close actions failed", error);
                                    }
                                }, 120);
                            },
                            queuePrevious () {
                            ...
                            selectAction (index) {
                                ...
                                this.$app.$def.setAction(selectedAction.id);
                                this.queueReturn();
                            },
                                ...
                                aiot.__ce__("div", {
                                    ...
                                    aiot.__ce__("div", {
                                        ...
                                        __opts__: {
                                            ...
                                            events: {
                                                click: function(evt) {
                                                    return _vm_.selectAction(0, evt);
                                                }
                                            }
                                        }
                                    }, [
                                    ...
                                    aiot.__ce__("div", {
                                        ...
                                        __opts__: {
                                            ...
                                            events: {
                                                click: function(evt) {
                                                    return _vm_.selectAction(1, evt);
                                                }
                                            }
                                        }
                                    }, [
                                    ...
                                    aiot.__ce__("div", {
                                        ...
                                        __opts__: {
                                            ...
                                            events: {
                                                click: function(evt) {
                                                    return _vm_.selectAction(2, evt);
                                                }
                                            }
                                        }
                                    }, [
                                    ...
                                    aiot.__ce__("div", {
                                        ...
                                        __opts__: {
                                            ...
                                            events: {
                                                click: function(evt) {
                                                    return _vm_.selectAction(3, evt);
                                                }
                                            }
                                        }
                                    }, [
                                    ...
                                    aiot.__ce__("div", {
                                        ...
                                        __opts__: {
                                            ...
                                            events: {
                                                click: function(evt) {
                                                    return _vm_.selectAction(4, evt);
                                                }
                                            }
                                        }
                                    }, [
                                    ...
                                    aiot.__ce__("div", {
                                        ...
                                        __opts__: {
                                            classList: function() {
                                                const $classValue$ = 5 === _vm_.previewIndex ? "item item-6 item-selected" : "item item-6";
                                                if ('string' == typeof $classValue$) return $classValue$.split(' ').map((item)=>item.trim()).filter(Boolean);
                                                return $classValue$;
                                            },
                                            events: {
                                                click: function(evt) {
                                                    return _vm_.selectAction(5, evt);
                                                }
                                            }
                                        }
                                    }, [
                                        ...
                                        aiot.__ce__("div", {
                                            ...
                                            __opts__: {
                                                classList: function() {
                                                    const $classValue$ = 5 === _vm_.previewIndex ? "radio radio-selected" : "radio";
                                                    if ('string' == typeof $classValue$) return $classValue$.split(' ').map((item)=>item.trim()).filter(Boolean);
                                                    return $classValue$;
                                                }
                                            }
